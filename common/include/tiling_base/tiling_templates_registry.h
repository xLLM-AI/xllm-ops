...
#define REGISTER_TILING_TEMPLATE_WITH_SOCVERSION(op_type, class_name, soc_versions, priority)    \
    ...
    static Ops::Xllm::OpTiling::RegisterNew VAR_UNUSED##op_type##class_name##priority_register = \
        Ops::Xllm::OpTiling::RegisterNew(#op_type).tiling<class_name>(priority, soc_versions)
...
#define REGISTER_TILING_TEMPLATE(op_type, class_name, priority)                                \
    static Ops::Xllm::OpTiling::Register VAR_UNUSED##op_type_##class_name##priority_register = \
        Ops::Xllm::OpTiling::Register(op_type).tiling<class_name>(priority)
...
#define REGISTER_TILING_TEMPLATE_NEW(op_type, class_name, soc_version, priority)                 \
    [[maybe_unused]] uint32_t op_impl_register_template_##op_type##_##class_name##priority;      \
    static Ops::Xllm::OpTiling::RegisterNew VAR_UNUSED##op_type##class_name##priority_register = \
        Ops::Xllm::OpTiling::RegisterNew(#op_type).tiling<class_name>(priority, soc_version)
...
#define REGISTER_OPS_TILING_TEMPLATE(op_type, class_name, priority)                       \
    [[maybe_unused]] uint32_t op_impl_register_template_##op_type##_##class_name##priority;      \
    static Ops::Xllm::OpTiling::Register                                                  \
