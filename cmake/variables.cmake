...
# src path
get_filename_component(OPS_XLLM_CMAKE_DIR           "${OPS_XLLM_DIR}/cmake"                               REALPATH)
get_filename_component(OPS_XLLM_COMMON_INC          "${OPS_XLLM_DIR}/../common/include"                      REALPATH)
get_filename_component(OPS_XLLM_COMMON_INC_COMMON   "${OPS_XLLM_COMMON_INC}/common"                       REALPATH)
get_filename_component(OPS_XLLM_COMMON_INC_EXTERNAL "${OPS_XLLM_COMMON_INC}/external"                     REALPATH)
get_filename_component(OPS_XLLM_COMMON_INC_HEADERS  "${OPS_XLLM_COMMON_INC_EXTERNAL}/aclnn_kernels"       REALPATH)
get_filename_component(OPS_KERNEL_BINARY_SCRIPT     "${OPS_XLLM_DIR}/../scripts/kernel/binary_script"       REALPATH)
get_filename_component(OPS_KERNEL_BINARY_CONFIG     "${OPS_XLLM_DIR}/../scripts/kernel/binary_config"       REALPATH)
...
set(BIN_STATIC_INSTALL_DIR          packages/vendors/${VENDOR_NAME}_xllm_math/op_impl/ai_core/tbe/static)
if (ENABLE_BUILT_IN)
  set(ACLNN_INC_INSTALL_DIR           ops_xllm/built-in/op_impl/ai_core/tbe/op_api/include/aclnnop)
  set(ACLNN_INC_LEVEL2_INSTALL_DIR    ops_xllm/built-in/op_impl/ai_core/tbe/op_api/include/aclnnop/level2)
  set(ACLNN_LIB_INSTALL_DIR           ops_xllm/built-in/op_impl/ai_core/tbe/op_api/lib/linux/${CMAKE_SYSTEM_PROCESSOR})
  set(OPS_INFO_INSTALL_DIR            ops_xllm/built-in/op_impl/ai_core/tbe/config)
  set(IMPL_INSTALL_DIR                ops_xllm/built-in/op_impl/ai_core/tbe/impl/ops_xllm/ascendc)
  set(IMPL_DYNAMIC_INSTALL_DIR        ops_xllm/built-in/op_impl/ai_core/tbe/impl/ops_xllm/dynamic)
  set(BIN_KERNEL_INSTALL_DIR          ops_xllm/built-in/op_impl/ai_core/tbe/kernel)
  set(BIN_KERNEL_CONFIG_INSTALL_DIR   ops_xllm/built-in/op_impl/ai_core/tbe/kernel/config)
  set(BIN_STATIC_INSTALL_DIR          ops_xllm/built-in/op_impl/ai_core/tbe/static)
  set(OPHOST_INC_INSTALL_PATH         ops_xllm/built-in/op_impl/ai_core/tbe/op_host/include)
  set(OPHOST_LIB_INSTALL_PATH         ops_xllm/built-in/op_impl/ai_core/tbe/op_host/lib/linux/${CMAKE_SYSTEM_PROCESSOR})
  set(OPTILING_LIB_INSTALL_DIR        ${OPHOST_LIB_INSTALL_PATH})
  set(OPGRAPH_INC_INSTALL_DIR         ops_xllm/built-in/op_graph/inc)
  set(OPGRAPH_LIB_INSTALL_DIR         ops_xllm/built-in/op_graph/lib/linux/${CMAKE_SYSTEM_PROCESSOR})
  set(ONNX_PLUGIN_LIB_INSTALL_DIR     ops_xllm/built-in/framework/onnx)
  set(COMMON_INC_INSTALL_DIR          ops_xllm/include)
  set(COMMON_LIB_INSTALL_DIR          ops_xllm/lib)
  set(VERSION_INFO_INSTALL_DIR        ops_xllm)
  set(IMPL_INSTALL_DIR                ops_xllm/built-in/op_impl/ai_core/tbe/impl/ops_xllm)
endif()
...
set(OPAPI_INCLUDE
  ...
  ${AICPU_INC_DIRS}
  ${OPS_XLLM_DIR}/
  ${OPS_XLLM_DIR}/../common/include
  ${OPS_XLLM_DIR}/../common/include/external
  ${OPS_XLLM_DIR}/../common/include/common
  ${OPS_XLLM_DIR}/../common/include/static
  ${OPS_XLLM_DIR}/../common/stub/op_api
  $<$<NOT:$<BOOL:${BUILD_OPEN_PROJECT}>>:${TOP_DIR}/output/${PRODUCT}/aclnnop_resource>

  ${OPS_XLLM_DIR}/mc2/common/inc
  ${OPS_XLLM_DIR}/mc2/common/new_mc2_mm
...
set(OP_TILING_INCLUDE
  ...
  ${OPS_XLLM_DIR}/../common/include
  ${OPS_XLLM_DIR}/../common/include/
  ${OPS_XLLM_DIR}/../common/stub/op_tiling
  
  ${OPS_XLLM_DIR}/mc2/common
  ${OPS_XLLM_DIR}/mc2/common/inc
  ${OPS_XLLM_DIR}/mc2/common/new_mc2_mm
  ${OPS_XLLM_DIR}/mc2/3rd
  ${OPS_XLLM_DIR}/mc2
...
set(AICPU_INCLUDE
  ...
  ${OPS_XLLM_DIR}/../common/inc/common
  ${METADEF_INCLUDE_DIRS}
)

set(ONNX_PLUGIN_COMMON_INCLUDE
  ${OPS_XLLM_DIR}
  ${OPS_XLLM_DIR}/../common/include/framework
  ${OPS_XLLM_DIR}/../common/include/op_graph
  ${OPS_XLLM_DIR}/../common/stub/inc/framework
)
...
if(EXISTS ${TOP_DIR}/build/product/onetrack/sys_version/sys_version.conf)
    ...
    execute_process(COMMAND grep -Po "(?<=Version=)[0-9]+\.[0-9]+" ${OPS_XLLM_DIR}/version.info
        OUTPUT_VARIABLE SYS_VERSION
        OUTPUT_STRIP_TRAILING_WHITESPACE
    )
endif()
