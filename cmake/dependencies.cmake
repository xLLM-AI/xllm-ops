...
set(OPS_XLLM_CXX_FLAGS)
string(APPEND OPS_XLLM_CXX_FLAGS " ${COMPILE_OP_MODE}")
string(APPEND OPS_XLLM_CXX_FLAGS " -Wall")
string(APPEND OPS_XLLM_CXX_FLAGS " -Wextra")
string(APPEND OPS_XLLM_CXX_FLAGS " -Wshadow")
string(APPEND OPS_XLLM_CXX_FLAGS " -Wformat=2")
string(APPEND OPS_XLLM_CXX_FLAGS " -fno-common")
string(APPEND OPS_XLLM_CXX_FLAGS " -fPIC")
if(NOT "${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
#  string(APPEND OPS_XLLM_CXX_FLAGS " -Werror")   # TODO: add -Werror when fix all compile warnings
  string(APPEND OPS_XLLM_CXX_FLAGS " -Wformat-signedness")
  string(APPEND OPS_XLLM_CXX_FLAGS " -Wno-missing-include-dirs")
  string(APPEND OPS_XLLM_CXX_FLAGS " -Wno-write-strings")
endif()
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${OPS_XLLM_CXX_FLAGS}")
