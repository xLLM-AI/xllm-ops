...
find_package_handle_standard_args(ascend_protobuf_build_xllm
    FOUND_VAR
    ascend_protobuf_build_xllm_FOUND
    REQUIRED_VARS
    ASCEND_PROTOBUF_SHARED_INCLUDE
)

set(ASCEND_PROTOBUF_SOURCE_DIR ${PROJECT_SOURCE_DIR}/../third_party/ascend_protobuf)
if(ascend_protobuf_build_xllm_FOUND AND NOT FORCE_REBUILD_CANN_3RD)
    ...
    add_library(ascend_protobuf_build_xllm INTERFACE)
else()
    ...
    ExternalProject_Add(ascend_protobuf_build_xllm
                        URL ${REQ_URL}
    ...
    if(TARGET abseil_build_xllm)
        add_dependencies(ascend_protobuf_build_xllm abseil_build_xllm)
    endif()

    ExternalProject_Get_Property(ascend_protobuf_build_xllm SOURCE_DIR)
    ExternalProject_Get_Property(ascend_protobuf_build_xllm BINARY_DIR)
    ...
    add_custom_command(
        ...
        DEPENDS ascend_protobuf_build_xllm
    )
endif()