...
if(UT_TEST_ALL OR OP_HOST_UT)
  ...
  function(add_optiling_ut_modules OP_TILING_MODULE_NAME)
    # add optiling ut common object: xllm_op_tiling_ut_common_obj
    ...
    # add optiling ut cases object: xllm_op_tiling_ut_cases_obj
    ...
    # add op tiling ut cases static lib: libxllm_op_tiling_ut_cases.a
  ...
  function(add_infershape_ut_modules OP_INFERSHAPE_MODULE_NAME)
    # add opinfershape ut common object: xllm_op_infershape_ut_common_obj
    ...
    # add opinfershape ut cases object: xllm_op_infershape_ut_cases_obj
    ...
    # add op infershape ut cases static lib: libxllm_op_infershape_ut_cases.a
...
if(UT_TEST_ALL OR OP_KERNEL_UT)
  ...
  function(add_opkernel_ut_modules OP_KERNEL_MODULE_NAME)
    # add opkernel ut common object: xllm_op_kernel_ut_common_obj
    ...
    foreach(socVersion ${fastOpTestSocVersions})
      # add op kernel ut cases obj: xllm_op_tiling_ut_${socVersion}_cases
      ...
      # add op kernel ut cases dynamic lib: libxllm_op_tiling_ut_${socVersion}_cases.so
      add_library(
  ...
  function(add_modules_ut_sources)
    ...
    if(${ARCH_NAME} STREQUAL "op_host")
      ...
      if("${MODULE_UT_NAME}" STREQUAL "${OP_TILING_MODULE_NAME}")
        ...
        # add op_tiling ut common object: xllm_op_tiling_ut_cases_obj
      ...
      if("${MODULE_UT_NAME}" STREQUAL "${OP_INFERSHAPE_MODULE_NAME}")
        ...
        # add op_infershape ut common object: xllm_op_infershape_ut_cases_obj
        if(NOT TARGET ${MODULE_UT_NAME}_cases_obj)
          add_library(${MODULE_UT_NAME}_cases_obj OBJECT)
        endif()
    ...
    if("${MODULE_UT_NAME}" STREQUAL "${OP_API_MODULE_NAME}")
      ...
      # add op_api ut common object: xllm_op_api_ut_cases_obj
...
if(UT_TEST_ALL OR OP_KERNEL_UT)
  ...
  function(AddOpTestCase opName supportedSocVersion otherCompileOptions tilingSrcFiles)
    ...
    foreach(oriSocVersion ${supportedSocVersion})
      ...
      set(gen_tiling_head_file ${OPS_XLLM_DIR}/tests/ut/framework_normal/op_kernel/scripts/gen_tiling_head_file.sh)
      ...
      # add object: xllm_op_kernel_ut_${oriSocVersion}_cases_obj
