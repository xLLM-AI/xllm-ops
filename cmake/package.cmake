...
function(pack_custom)
  ...
  set(PACK_CUSTOM_NAME "cann-ops-xllm-${VENDOR_NAME}-linux-${ARCH}")
...
function(pack_tiling_sink)
  ...
  if(ENABLE_BUILT_IN)
    set(XLLM_OPMASTER_SO ${BINARY_DIR}/libtiling_device_xllm.so)
    set(INSTALL_DIR "ops_xllm/built-in/op_impl/ai_core/tbe/op_tiling_device/lib")
  else()
    set(XLLM_OPMASTER_SO ${BINARY_DIR}/libcust_opmaster.so)
    set(INSTALL_DIR "packages/vendors/${VENDOR_NAME}_xllm_math/op_impl/ai_core/tbe/op_master_device/lib")
  endif()
  install(CODE "
    if(EXISTS \"${XLLM_OPMASTER_SO}\")
      file(
        INSTALL DESTINATION \"\${CMAKE_INSTALL_PREFIX}/${INSTALL_DIR}\"
        TYPE FILE FILES \"${XLLM_OPMASTER_SO}\")
    endif()
  ")
endfunction()
...
function(pack_built_in)
  ...
  set(script_prefix ${CMAKE_SOURCE_DIR}/../scripts/package/ops_xllm/scripts)
  ...
  if(NOT ENABLE_OPS_KERNEL)
    ...
    if("${VERSION}" STREQUAL "")
      if("${soc_version}" STREQUAL "910_93")
        set(CPACK_PACKAGE_FILE_NAME "cann-A3-ops-xllm_linux-${ARCH}.run")
      else()
        set(CPACK_PACKAGE_FILE_NAME "cann-${soc_version}-ops-xllm_linux-${ARCH}.run")
      endif()
    else()
      if("${soc_version}" STREQUAL "910_93")
        set(CPACK_PACKAGE_FILE_NAME "cann-A3-ops-xllm_${VERSION}_linux-${ARCH}.run")
      else()
