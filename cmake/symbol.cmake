...
function(gen_common_symbol)
  install(DIRECTORY ${OPS_XLLM_COMMON_INC_HEADERS}
...
function(gen_opgraph_symbol)
  ...
  set_target_properties(${OPGRAPH_NAME} PROPERTIES OUTPUT_NAME "opgraph_xllm")
  install(TARGETS ${OPGRAPH_NAME}
    LIBRARY DESTINATION ${OPGRAPH_LIB_INSTALL_DIR}
  )
  install(FILES ${ASCEND_GRAPH_CONF_DST}/ops_proto_xllm.h
...
function(gen_cust_aicpu_json_symbol)
  ...
  install(
    FILES ${MERGED_JSON}
    DESTINATION packages/vendors/${VENDOR_NAME}_xllm_math/op_impl/cpu/config
    OPTIONAL
  )
endfunction()
...
function(gen_cust_aicpu_kernel_symbol)
  ...
  install(
    FILES ${ARM_SO_OUTPUT}
    DESTINATION packages/vendors/${VENDOR_NAME}_xllm_math/op_impl/cpu/aicpu_kernel/impl
    OPTIONAL
  )
endfunction()
