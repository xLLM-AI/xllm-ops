...
find_path(dlog_XLLM_INCLUDE_DIR
  NAMES dlog_pub.h
...
find_package_handle_standard_args(dlog
  FOUND_VAR
    dlog_FOUND
  REQUIRED_VARS
    dlog_XLLM_INCLUDE_DIR
)

if(dlog_FOUND)
  include(CMakePrintHelpers)
  message(STATUS "Xllm Variables in dlog module:")
  cmake_print_variables(dlog_XLLM_INCLUDE_DIR)
  ...
  set(XLLM_INTERFACE_INCLUDE "${dlog_XLLM_INCLUDE_DIR}")
  string(FIND "${dlog_XLLM_INCLUDE_DIR}" "toolchain" IDX)
  if(NOT IDX EQUAL -1)
    set(XLLM_INTERFACE_INCLUDE "${XLLM_INTERFACE_INCLUDE};${dlog_XLLM_INCLUDE_DIR}/..")
  endif()
  add_library(dlog_headers INTERFACE IMPORTED)
  set_target_properties(dlog_headers PROPERTIES
    INTERFACE_INCLUDE_DIRECTORIES "${XLLM_INTERFACE_INCLUDE}"
  )
