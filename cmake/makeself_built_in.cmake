...
execute_process(
    COMMAND python3 ${CPACK_CMAKE_SOURCE_DIR}/../scripts/package/package.py --pkg_name ops_xllm --chip_name ${CPACK_SOC} --os_arch linux-${CPACK_ARCH} --version_dir ${CPACK_VERSION}
...
set(XLLM_VERSION_OUT_PUT
    ${CPACK_CMAKE_BINARY_DIR}/ops_xllm_version.h
)

configure_file(
    ${SCENE_OUT_PUT}
    ${STAGING_DIR}/share/info/ops_xllm/
    COPYONLY
)
configure_file(
    ${CSV_OUTPUT}
    ${STAGING_DIR}/share/info/ops_xllm/script/
    COPYONLY
)
configure_file(
    ${XLLM_VERSION_OUT_PUT}
    ${STAGING_DIR}/share/info/ops_xllm/
    COPYONLY
)
# makeself打包
...
execute_process(COMMAND bash ${MAKESELF_EXE}
        ...
        --help-header share/info/ops_xllm/script/help.info
        ${makeself_param_string} share/info/ops_xllm/script/install.sh
