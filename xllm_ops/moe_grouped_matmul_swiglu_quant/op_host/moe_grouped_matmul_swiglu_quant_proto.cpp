...
static ge::graphStatus InferShape4MoeGroupedMatmulSwigluQuant(gert::InferShapeContext *context)
{
    std::cout << "-----enter moegmm infershape---------------" << std::endl;
    ...
    // printf("inferShape: m %d n %d\n", m, n);
    return GRAPH_SUCCESS;
}

static graphStatus InferDataType4MoeGroupedMatmulSwigluQuant(gert::InferDataTypeContext *context)
{
...
IMPL_OP_INFERSHAPE(MoeGroupedMatmulSwigluQuant)
    .InferShape(InferShape4MoeGroupedMatmulSwigluQuant)
    .InferDataType(InferDataType4MoeGroupedMatmulSwigluQuant);
} // namespace ops
