...
#ifndef MOE_GROUPED_MATMUL_SWIGLU_QUANT_SPLIT_WS_H
#define MOE_GROUPED_MATMUL_SWIGLU_QUANT_SPLIT_WS_H
...
class MoeGMMSwigluSplitWorkSpaceCompute {
public:
    ...
    /** @brief constructor */
    __aicore__ inline MoeGMMSwigluSplitWorkSpaceCompute(typename mmType::MT &mm_) : mm(mm_)
    {
    }
...
__aicore__ inline void MoeGMMSwigluSplitWorkSpaceCompute<mmType, sync, CHANNELDTYPE>::Init(
...
template <typename mmType, bool sync, typename CHANNELDTYPE>
__aicore__ inline void MoeGMMSwigluSplitWorkSpaceCompute<mmType, sync, CHANNELDTYPE>::InitWorkSpaceSplitConfig(
    WorkSpaceSplitConfig &workspaceSplitConfig)
{
...
template <typename mmType, bool sync, typename CHANNELDTYPE>
__aicore__ inline void MoeGMMSwigluSplitWorkSpaceCompute<mmType, sync, CHANNELDTYPE>::UpdateWorkSpaceSplitConfig(
...
template <typename mmType, bool sync, typename CHANNELDTYPE>
__aicore__ inline void MoeGMMSwigluSplitWorkSpaceCompute<mmType, sync, CHANNELDTYPE>::Process()
{
...
template <typename mmType, bool sync, typename CHANNELDTYPE>
template <typename DTYPE_CS>
__aicore__ inline void MoeGMMSwigluSplitWorkSpaceCompute<mmType, sync, CHANNELDTYPE>::PreLoadTokenAndChannel(
...
MoeGMMSwigluSplitWorkSpaceCompute<mmType, sync, CHANNELDTYPE>::MMCompute(uint32_t groupIdx, MNConfig &mnConfig,
...
template <typename mmType, bool sync, typename CHANNELDTYPE>
__aicore__ inline void MoeGMMSwigluSplitWorkSpaceCompute<mmType, sync, CHANNELDTYPE>::UpdateMnConfig(MNConfig &mnConfig)
{
...
template <typename mmType, bool sync, typename CHANNELDTYPE>
__aicore__ inline void MoeGMMSwigluSplitWorkSpaceCompute<mmType, sync, CHANNELDTYPE>::SetMNConfig(const int32_t splitValue,
...
template <typename mmType, bool sync, typename CHANNELDTYPE>
__aicore__ inline void MoeGMMSwigluSplitWorkSpaceCompute<mmType, sync, CHANNELDTYPE>::SetMKN(const int32_t splitValue,
                                                                                          const uint32_t groupIdx,
                                                                                          MNConfig &mnConfig)
{
...
template <typename mmType, bool sync, typename CHANNELDTYPE>
__aicore__ inline uint64_t MoeGMMSwigluSplitWorkSpaceCompute<mmType, sync, CHANNELDTYPE>::GetWOffset(uint32_t tailN,
                                                                                                  uint32_t k)
{
    uint64_t wOffset = 0;
...
template <typename mmType, bool sync, typename CHANNELDTYPE>
__aicore__ inline void MoeGMMSwigluSplitWorkSpaceCompute<mmType, sync, CHANNELDTYPE>::MNBlockIdxCompute(
...
template <typename mmType, bool sync, typename CHANNELDTYPE>
__aicore__ inline void MoeGMMSwigluSplitWorkSpaceCompute<mmType, sync, CHANNELDTYPE>::UpdateVecConfig(uint32_t blockIdx,
                                                                                                   VecConfig &vecConfig)
{
...
template <typename mmType, bool sync, typename CHANNELDTYPE>
__aicore__ inline void MoeGMMSwigluSplitWorkSpaceCompute<mmType, sync, CHANNELDTYPE>::customDataCopyIn(
...
template <typename DTYPE_CS>
__aicore__ inline void
MoeGMMSwigluSplitWorkSpaceCompute<mmType, sync, CHANNELDTYPE>::UpdateChannelScale(uint32_t loopIdx, VecConfig &vecConfig)
{
    // 更新perChannel
...
template <typename mmType, bool sync, typename CHANNELDTYPE>
__aicore__ inline void MoeGMMSwigluSplitWorkSpaceCompute<mmType, sync, CHANNELDTYPE>::VectorCompute(uint32_t loopIdx,
                                                                                                 VecConfig &vecConfig)
{
...
template <typename mmType, bool sync, typename CHANNELDTYPE>
__aicore__ inline void MoeGMMSwigluSplitWorkSpaceCompute<mmType, sync, CHANNELDTYPE>::Dequant(uint32_t loopIdx,
                                                                                           VecConfig &vecConfig)
{
...
template <typename mmType, bool sync, typename CHANNELDTYPE>
__aicore__ inline void MoeGMMSwigluSplitWorkSpaceCompute<mmType, sync, CHANNELDTYPE>::Swiglu(uint32_t loopIdx,
                                                                                          VecConfig &vecConfig)
{
    // 高阶API swiglu
...
template <typename mmType, bool sync, typename CHANNELDTYPE>
__aicore__ inline void MoeGMMSwigluSplitWorkSpaceCompute<mmType, sync, CHANNELDTYPE>::Quant(uint32_t loopIdx,
                                                                                         VecConfig &vecConfig)
{
    LocalTensor<float> _inMMLocal = mmOutQueue.DeQue<float>();
...
template <typename mmType, bool sync, typename CHANNELDTYPE>
__aicore__ inline void
MoeGMMSwigluSplitWorkSpaceCompute<mmType, sync, CHANNELDTYPE>::customDataCopyOut(VecConfig &vecConfig)
{
    LocalTensor<float> quantScaleLocal = quantScaleOutQueue.DeQue<float>();
