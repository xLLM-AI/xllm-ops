...
#ifndef MOE_GROUPED_MATMUL_SWIGLU_QUANT_UTILS_H
#define MOE_GROUPED_MATMUL_SWIGLU_QUANT_UTILS_H
...
constexpr int64_t GROUP_LIST_INNER_SHAPE = 2;
...
#endif // MOE_GROUPED_MATMUL_SWIGLU_QUANT
