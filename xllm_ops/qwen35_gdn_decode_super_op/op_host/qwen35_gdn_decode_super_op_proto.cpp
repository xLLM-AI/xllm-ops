...
static ge::graphStatus InferShapeQwen35GdnDecodeSuperOp(gert::InferShapeContext* context)
{
...
IMPL_OP_INFERSHAPE(Qwen35GdnDecodeSuperOp).InferShape(InferShapeQwen35GdnDecodeSuperOp);
