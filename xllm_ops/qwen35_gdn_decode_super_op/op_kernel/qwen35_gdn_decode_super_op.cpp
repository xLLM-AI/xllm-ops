...
extern "C" __global__ __aicore__ void qwen35_gdn_decode_super_op(
  ...
  auto hist_half0 = ascend_ub.GetWithOffset<bfloat16_t>(128, 1024);
  auto hist_half1 = ascend_ub.GetWithOffset<bfloat16_t>(128, 1280);
  auto hist_half2 = ascend_ub.GetWithOffset<bfloat16_t>(128, 1536);
  auto x_half = ascend_ub.GetWithOffset<bfloat16_t>(128, 1792);
  auto w0 = ascend_ub.GetWithOffset<float>(128, 2048);
  auto w1 = ascend_ub.GetWithOffset<float>(128, 2560);
  auto w2 = ascend_ub.GetWithOffset<float>(128, 3072);
  auto w3 = ascend_ub.GetWithOffset<float>(128, 3584);
  ...
  auto norm_val = ascend_ub.GetWithOffset<float>(1, 10880);
  auto tmp_ub = ascend_ub.GetWithOffset<uint8_t>(32768, 10912);
  ...
  int32_t state_idx = state_indices.GetValue(0);
  ...
  tl::ascend::copy_gm_to_ub<bfloat16_t, 128>(hist_half0[0], conv_state[(((state_idx * 15360) + (cid * 256)) + (vid * 128))], 61440, 1, 128, bfloat16_t(0.000000e+00f));
  tl::ascend::copy_gm_to_ub<bfloat16_t, 128>(hist_half1[0], conv_state[((((state_idx * 15360) + (cid * 256)) + (vid * 128)) + 5120)], 61440, 1, 128, bfloat16_t(0.000000e+00f));
  tl::ascend::copy_gm_to_ub<bfloat16_t, 128>(hist_half2[0], conv_state[((((state_idx * 15360) + (cid * 256)) + (vid * 128)) + 10240)], 61440, 1, 128, bfloat16_t(0.000000e+00f));
  tl::ascend::copy_gm_to_ub<bfloat16_t, 128>(x_half[0], qkv[((cid * 256) + (vid * 128))], 5120, 1, 128, bfloat16_t(0.000000e+00f));
  ...
  AscendC::SetFlag<AscendC::HardEvent::V_MTE3>(2);
  AscendC::WaitFlag<AscendC::HardEvent::V_MTE3>(2);
  tl::ascend::copy_ub_to_gm<bfloat16_t, 128>(conv_out[((cid * 256) + (vid * 128))], y_half[0], 5120, 1, 128);
  tl::ascend::copy_ub_to_gm<bfloat16_t, 128>(conv_state_out[(((state_idx * 15360) + (cid * 256)) + (vid * 128))], save_half0[0], 61440, 1, 128);
  AscendC::PipeBarrier<PIPE_MTE3>();
  tl::ascend::copy_ub_to_gm<bfloat16_t, 128>(conv_state_out[((((state_idx * 15360) + (cid * 256)) + (vid * 128)) + 5120)], save_half1[0], 61440, 1, 128);
  AscendC::PipeBarrier<PIPE_MTE3>();
  tl::ascend::copy_ub_to_gm<bfloat16_t, 128>(conv_state_out[((((state_idx * 15360) + (cid * 256)) + (vid * 128)) + 10240)], save_half2[0], 61440, 1, 128);
  AscendC::SetFlag<AscendC::HardEvent::MTE3_V>(3);
  AscendC::WaitFlag<AscendC::HardEvent::MTE3_V>(3);
  AscendC::SyncAll<false>();
  AscendC::PipeBarrier<PIPE_ALL>();
  if (cid < 12) {
    tl::ascend::copy_gm_to_ub<bfloat16_t, 128>(q_half[0], conv_out[((((cid * 2) + vid) / 3) * 128)], 5120, 1, 128, bfloat16_t(0.000000e+00f));
    tl::ascend::copy_gm_to_ub<bfloat16_t, 128>(k_half[0], conv_out[(((((cid * 2) + vid) / 3) * 128) + 1024)], 5120, 1, 128, bfloat16_t(0.000000e+00f));
    tl::ascend::copy_gm_to_ub<bfloat16_t, 1>(a_half[0], a[((cid * 2) + vid)], 24, 1, 1, bfloat16_t(0.000000e+00f));
    tl::ascend::copy_gm_to_ub<bfloat16_t, 1>(b_half[0], b[((cid * 2) + vid)], 24, 1, 1, bfloat16_t(0.000000e+00f));
    ...
    tl::ascend::copy_gm_to_ub<float, 1>(scalar_tmp[0], a_log[((cid * 2) + vid)], 24, 1, 1, 0.000000e+00f);
    ...
    tl::ascend::copy_gm_to_ub<float, 1>(norm_val[0], dt_bias[((cid * 2) + vid)], 24, 1, 1, 0.000000e+00f);
    ...
    for (int32_t half_idx = 0; half_idx < 2; ++half_idx) {
      ...
      tl::ascend::copy_gm_to_ub<bfloat16_t, 64>(v_half[0], conv_out[((((cid * 256) + (vid * 128)) + (half_idx * 64)) + 2048)], 5120, 1, 64, bfloat16_t(0.000000e+00f));
      AscendC::SetFlag<AscendC::HardEvent::MTE3_MTE2>(0);
      AscendC::WaitFlag<AscendC::HardEvent::MTE3_MTE2>(0);
      tl::ascend::copy_gm_to_ub<float, 64, 128>(h_vec[0], ssm_state[((((state_idx * 393216) + (cid * 32768)) + (vid * 16384)) + (half_idx * 64))], 128, 128, 64, 0.000000e+00f);
      AscendC::SetFlag<AscendC::HardEvent::MTE2_V>(4);
      AscendC::WaitFlag<AscendC::HardEvent::MTE2_V>(4);
      AscendC::SetFlag<AscendC::HardEvent::MTE2_V>(6);
      AscendC::WaitFlag<AscendC::HardEvent::MTE2_V>(6);
      ...
      AscendC::PipeBarrier<PIPE_MTE3>();
      tl::ascend::copy_ub_to_gm<float, 64, 128>(ssm_state_out[((((state_idx * 393216) + (cid * 32768)) + (vid * 16384)) + (half_idx * 64))], h_vec[0], 128, 128, 64);
      AscendC::SetFlag<AscendC::HardEvent::MTE3_V>(6);
      AscendC::WaitFlag<AscendC::HardEvent::MTE3_V>(6);
    }
    tl::ascend::copy_gm_to_ub<bfloat16_t, 128>(z_half[0], z[((cid * 256) + (vid * 128))], 3072, 1, 128, bfloat16_t(0.000000e+00f));
    ...
    tl::ascend::copy_ub_to_gm<bfloat16_t, 128>(out[((cid * 256) + (vid * 128))], final_half[0], 3072, 1, 128);
  }
  AscendC::PipeBarrier<PIPE_ALL>();
  }
}
