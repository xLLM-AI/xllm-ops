...
__attribute__((visibility("default"))) aclnnStatus aclnnMegaChunkGdnGetWorkspaceSize(
...
__attribute__((visibility("default"))) aclnnStatus aclnnMegaChunkGdn(void *workspace, uint64_t workspaceSize,
