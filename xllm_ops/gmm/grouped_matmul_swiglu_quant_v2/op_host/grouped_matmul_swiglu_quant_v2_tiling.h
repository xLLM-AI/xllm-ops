...
class GroupedMatmulSwigluQuantV2Tiling : public Ops::Xllm::OpTiling::TilingBaseClass {
public:
    explicit GroupedMatmulSwigluQuantV2Tiling(gert::TilingContext* context) : Ops::Xllm::OpTiling::TilingBaseClass(context) {};
