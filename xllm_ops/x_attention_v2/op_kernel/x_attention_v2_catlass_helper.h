...
#ifndef X_ATTN_V2_CATLASS_HELPER_H
#define X_ATTN_V2_CATLASS_HELPER_H
#include "x_attention_v2_catlass_kernel.h"

template <typename INPUT_T, bool isPAEnabled>
CATLASS_DEVICE void CallSharedInferKernelShort(const XAttnKernelParams& params, XAttentionV2TilingData* tilingData) {
...
template <typename INPUT_T, bool isPAEnabled>
CATLASS_DEVICE void CallUnsharedInferKernel(const XAttnKernelParams& params, XAttentionV2TilingData* tilingData) {
using ArchTag = Arch::AtlasA2;
using ElementQ = INPUT_T;
using LayoutQ = layout::RowMajor;
using ElementK = INPUT_T;
...
CATLASS_DEVICE void CallCombineScale(const XAttnKernelParams& params, XAttentionV2TilingData* tilingData) {
using ArchTag = Arch::AtlasA2;
