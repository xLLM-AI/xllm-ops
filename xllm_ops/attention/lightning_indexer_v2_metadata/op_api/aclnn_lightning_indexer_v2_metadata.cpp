...
#include "../op_host/lightning_indexer_v2_metadata_check.h"
    ...
    aclOpExecutor **executor)
{
    if (workspaceSize == nullptr) {
        OP_LOGE("aclnnLightningIndexerV2Metadata", "workspaceSize is nullptr");
        return ACLNN_ERR_INNER_NULLPTR;
    }
    if (executor == nullptr) {
        OP_LOGE("aclnnLightningIndexerV2Metadata", "executor is nullptr");
        return ACLNN_ERR_INNER_NULLPTR;
    }
    ...
    if (cuSeqlensQOptional != nullptr) {
        ...
        if (cuSeqlensQOptionalContiguous == nullptr) {
            OP_LOGE("aclnnLightningIndexerV2Metadata", "cu_seqlens_q contiguous is null");
            return ACLNN_ERR_INNER_NULLPTR;
        }
    }
    ...
    if (cuSeqlensKOptional != nullptr) {
        ...
        if (cuSeqlensKOptionalContiguous == nullptr) {
            OP_LOGE("aclnnLightningIndexerV2Metadata", "cu_seqlens_k contiguous is null");
            return ACLNN_ERR_INNER_NULLPTR;
        }
    }
    ...
    if (sequsedQOptional != nullptr) {
        ...
        if (sequsedQOptionalContiguous == nullptr) {
            OP_LOGE("aclnnLightningIndexerV2Metadata", "seqused_q contiguous is null");
            return ACLNN_ERR_INNER_NULLPTR;
        }
    }
    ...
    if (sequsedKOptional != nullptr) {
        ...
        if (sequsedKOptionalContiguous == nullptr) {
            OP_LOGE("aclnnLightningIndexerV2Metadata", "seqused_k contiguous is null");
            return ACLNN_ERR_INNER_NULLPTR;
        }
    }
    ...
    if (cmpResidualKOptional != nullptr) {
        ...
        if (cmpResidualLKOptionalContiguous == nullptr) {
            OP_LOGE("aclnnLightningIndexerV2Metadata", "cmp_residual_k contiguous is null");
            return ACLNN_ERR_INNER_NULLPTR;
        }
    }
