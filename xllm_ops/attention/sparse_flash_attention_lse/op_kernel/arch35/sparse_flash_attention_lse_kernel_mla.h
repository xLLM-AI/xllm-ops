...
#include "sparse_flash_attention_lse_common_arch35.h"
#include "sparse_flash_attention_lse_kvcache.h"
...
namespace BaseApi {
template <typename CubeBlockType, typename VecBlockType> class SparseFlashAttentionLseKernelMla {
public:
    ARGS_TRAITS;

    __aicore__ inline SparseFlashAttentionLseKernelMla(){};
    __aicore__ inline void Init(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value,
                                ...
                                const SparseFlashAttentionLseTilingDataMla *__restrict tiling,
...
template <typename CubeBlockType, typename VecBlockType>
 __aicore__ inline void SparseFlashAttentionLseKernelMla<CubeBlockType, VecBlockType>::Init(
...
void SparseFlashAttentionLseKernelMla<CubeBlockType, VecBlockType>::InitCalcParamsEach()
{
    // 计算总的基本块
...
SparseFlashAttentionLseKernelMla<CubeBlockType, VecBlockType>::GetBalanceActualSeqLengths(
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseFlashAttentionLseKernelMla<CubeBlockType, VecBlockType>::GetAxisStartIdx(uint32_t bN2EndPrev,
                                                                                uint32_t s1GEndPrev,
                                                                                uint32_t s2EndPrev)
{
...
template <typename CubeBlockType, typename VecBlockType> __aicore__ inline
void SparseFlashAttentionLseKernelMla<CubeBlockType, VecBlockType>::InitGlobalBuffer(
    __gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value,
    __gm__ uint8_t *queryRope, __gm__ uint8_t *keyRope, __gm__ uint8_t *sparseIndices,
    __gm__ uint8_t *blockTable, __gm__ uint8_t *actualSeqLengthsQ, __gm__ uint8_t *actualSeqLengths,
    __gm__ uint8_t *softmaxMax, __gm__ uint8_t *softmaxSum,
    __gm__ uint8_t *workspace, const SparseFlashAttentionLseTilingDataMla *__restrict tiling, TPipe *tPipe)
{
...
SparseFlashAttentionLseKernelMla<CubeBlockType, VecBlockType>::InitMMResBuf(__gm__ uint8_t *workspace)
{
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseFlashAttentionLseKernelMla<CubeBlockType, VecBlockType>::InitLocalBuffer()
{
    vecBlock.InitLocalBuffer(pipe, constInfo);
}

template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseFlashAttentionLseKernelMla<CubeBlockType, VecBlockType>::ComputeConstexpr()
{
    // 计算轴的乘积
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseFlashAttentionLseKernelMla<CubeBlockType, VecBlockType>::InitUniqueConstInfo()
{
    // bsize + 1-> bsize
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseFlashAttentionLseKernelMla<CubeBlockType, VecBlockType>::Process()
{
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseFlashAttentionLseKernelMla<CubeBlockType, VecBlockType>::ProcessMainLoop()
{
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseFlashAttentionLseKernelMla<CubeBlockType, VecBlockType>::ComputeAxisIdxByBnAndGs1(
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseFlashAttentionLseKernelMla<CubeBlockType, VecBlockType>::SetRunInfo(
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseFlashAttentionLseKernelMla<CubeBlockType, VecBlockType>::InitUniqueRunInfo(
...
template <typename CubeBlockType, typename VecBlockType>
__aicore__ inline void SparseFlashAttentionLseKernelMla<CubeBlockType, VecBlockType>::ComputeBmm1Tail(
