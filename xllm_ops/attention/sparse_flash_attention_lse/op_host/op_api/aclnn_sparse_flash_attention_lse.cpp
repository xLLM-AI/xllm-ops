...
#include "aclnn_sparse_flash_attention_lse.h"
...
extern aclnnStatus aclnnInnerSparseFlashAttentionLseGetWorkspaceSize(
...
extern aclnnStatus aclnnInnerSparseFlashAttentionLse(void *workspace, uint64_t workspaceSize, aclOpExecutor *executor,
    ...
    aclOpExecutor **executor)
{
    ...
    return aclnnInnerSparseFlashAttentionLseGetWorkspaceSize(
...
aclnnStatus aclnnSparseFlashAttentionLse(void *workspace, uint64_t workspaceSize, aclOpExecutor *executor,
                                     const aclrtStream stream)
{
    return aclnnInnerSparseFlashAttentionLse(workspace, workspaceSize, executor, stream);
}
