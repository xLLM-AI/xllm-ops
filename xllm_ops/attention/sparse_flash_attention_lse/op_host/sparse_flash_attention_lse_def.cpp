...
/*!
 * \file sparse_flash_attention_lse_def.cpp
 * \brief
 */
...
namespace ops {
class SparseFlashAttentionLse : public OpDef {
public:
    explicit SparseFlashAttentionLse(const char *name) : OpDef(name)
    {
        this->Input("query")
            .ParamType(REQUIRED)
...
OP_ADD(SparseFlashAttentionLse);
} // namespace ops
