...
/*!
 * \file sparse_flash_attention_lse_proto.cpp
 * \brief
 */
...
ge::graphStatus InferShapeSparseFlashAttentionLse(gert::InferShapeContext *context)
{  
    OP_CHECK_IF(context == nullptr, OP_LOGE("SparseFlashAttentionLse", "InferShapeContext is nullptr"),
...
ge::graphStatus InferDataTypeSparseFlashAttentionLse(gert::InferDataTypeContext *context)
{
    OP_CHECK_IF(context == nullptr, OP_LOGE("SparseFlashAttentionLse", "InferShapeContext is nullptr"),
               return ge::GRAPH_FAILED);
...
IMPL_OP_INFERSHAPE(SparseFlashAttentionLse)
    .InferShape(InferShapeSparseFlashAttentionLse)
    .InferDataType(InferDataTypeSparseFlashAttentionLse);
} // namespace ops
