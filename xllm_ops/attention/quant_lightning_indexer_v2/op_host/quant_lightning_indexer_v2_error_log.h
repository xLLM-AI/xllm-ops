...
#define OP_LOGE_FOR_INVALID_DTYPES_WITH_REASON(opname, param, actual, reason) \
    OP_LOGE(opname, "Invalid dtypes for %s, actual: %s, reason: %s", param, actual, reason)
#endif
...
#define OP_LOGE_FOR_INVALID_SHAPEDIM_WITH_REASON(opname, param, actual, reason) \
    OP_LOGE(opname, "Invalid shape dim for %s, actual: %s, reason: %s", param, actual, reason)
#endif
...
#define OP_LOGE_FOR_INVALID_VALUES_WITH_REASON(opname, param, actual, reason) \
    OP_LOGE(opname, "Invalid values for %s, actual: %s, reason: %s", param, actual, reason)
#endif