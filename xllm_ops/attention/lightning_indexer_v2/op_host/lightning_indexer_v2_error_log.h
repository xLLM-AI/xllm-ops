...
// NOTE: The *_WITH_REASON macros follow the source-repo convention of (opname, param, reason)
// i.e. 3 arguments. The non-reason variants (_DTYPE/_SHAPE/_SHAPEDIM/_SHAPESIZE/_VALUE) use
// 4 arguments (opname, param, actual, expected). Variadic tails keep both callsite styles working.
...
#define OP_LOGE_FOR_INVALID_DTYPE_WITH_REASON(opname, param, reason, ...) \
    OP_LOGE(opname, "Invalid dtype for %s, reason: %s", param, reason)
#endif

#ifndef OP_LOGE_FOR_INVALID_DTYPES_WITH_REASON
#define OP_LOGE_FOR_INVALID_DTYPES_WITH_REASON(opname, param, reason, ...) \
    OP_LOGE(opname, "Invalid dtypes for %s, reason: %s", param, reason)
#endif
...
#define OP_LOGE_FOR_INVALID_SHAPE_WITH_REASON(opname, param, reason, ...) \
    OP_LOGE(opname, "Invalid shape for %s, reason: %s", param, reason)
#endif

#ifndef OP_LOGE_FOR_INVALID_SHAPES_WITH_REASON
#define OP_LOGE_FOR_INVALID_SHAPES_WITH_REASON(opname, param, reason, ...) \
    OP_LOGE(opname, "Invalid shapes for %s, reason: %s", param, reason)
#endif
...
#define OP_LOGE_FOR_INVALID_SHAPEDIM_WITH_REASON(opname, param, reason, ...) \
    OP_LOGE(opname, "Invalid shape dim for %s, reason: %s", param, reason)
#endif

#ifndef OP_LOGE_FOR_INVALID_SHAPEDIMS_WITH_REASON
#define OP_LOGE_FOR_INVALID_SHAPEDIMS_WITH_REASON(opname, param, reason, ...) \
    OP_LOGE(opname, "Invalid shape dims for %s, reason: %s", param, reason)
#endif
...
#define OP_LOGE_FOR_INVALID_SHAPESIZE_WITH_REASON(opname, param, reason, ...) \
    OP_LOGE(opname, "Invalid shape size for %s, reason: %s", param, reason)
#endif

#ifndef OP_LOGE_FOR_INVALID_SHAPESIZES_WITH_REASON
#define OP_LOGE_FOR_INVALID_SHAPESIZES_WITH_REASON(opname, param, reason, ...) \
    OP_LOGE(opname, "Invalid shape size for %s, reason: %s", param, reason)
#endif
...
#define OP_LOGE_FOR_INVALID_VALUE_WITH_REASON(opname, param, reason, ...) \
    OP_LOGE(opname, "Invalid value for %s, reason: %s", param, reason)
#endif

#ifndef OP_LOGE_FOR_INVALID_VALUES_WITH_REASON
#define OP_LOGE_FOR_INVALID_VALUES_WITH_REASON(opname, param, reason, ...) \
    OP_LOGE(opname, "Invalid values for %s, reason: %s", param, reason)
#endif